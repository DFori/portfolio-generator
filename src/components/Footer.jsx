      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="text-xl font-bold">PortfolioBuilder</Link>
            <p className="text-gray-400 mt-2">Showcase your work with a professional portfolio</p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} PortfolioBuilder. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
